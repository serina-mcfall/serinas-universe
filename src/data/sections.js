export const SECTIONS = [
  ...
  },
  {
    ...
    prompts: [
      ...
      { id: "crownprince", label: "The Crown Prince — Chén Jǐng", placeholder: "Heir to the Chén Dynasty. Coiled-young-dragon strategist. The cipher-letter conspirator. The granite-armoured grief-carrier. The three-wife trinity — Strategy, Mercy, Love..." },
      { id: "princewu", label: "The Second Prince — Chén Wǔ", placeholder: "Head of the Imperial Guard. The warrior-prince. The one who should have been heir — Aoli has flipped the trope..." },
      { id: "princeqing", label: "The Third Prince — Chén Qīng", placeholder: "Concealed as Yōu Lán, the Dream Walker of Hun Sect. The son behind the veil of mist..." },
      { id: "princesslan", label: "The Princess — Chén Lán", placeholder: "Princess of Aoli. Named for the orchid — her father's dead brother's flower. The grief-flower made flesh..." },
      { id: "courtstructure", label: "The Imperial Court Structure", placeholder: "Three Ducal Ministers, Nine Ministers, supporting offices. Faction balance: numbers vs levers. The silent truth-network..." },
      { id: "selection", label: "The Crown Princess Selection", placeholder: "Eight candidates — four general-clan daughters and four Mù jade sisters. The ceremony, the stakes, the secret bloodline walking in disguise..." },
      { id: "lumei", label: "Lǔ Méi — The Broom Girl", placeholder: "The pattern-seer investigator. The third consort in Jǐng's trinity. The woman who beat the Crown Prince with a broom and has no idea..." },
  ...
  },
  {
    ...
    prompts: [
      { id: "overview", label: "The Realm", placeholder: "Sky cities. Magic outlawed. Floating islands held aloft by an ancient lake and the desperate substitute of blood magic..." },
      { id: "history", label: "The Ancient Uplift", placeholder: "How Aurum came to be — the ancestors' flight from Yuèlì's corruption, the tearing of the land, the magic-ban as protection..." },
      { id: "bloodmagic", label: "The Blood Magic Secret", placeholder: "The ruling class secret. The substitute when the original magic faded. How it works, who feeds it, what it costs..." },
      { id: "royalhouse", label: "The Royal House + The High Chancellor", placeholder: "The throne over the dying Hope-tree. Guì the Blood Witch as centuries-old infiltrator. The 50-year fakery..." },
      { id: "politics", label: "Power & Control", placeholder: "Six-tier class system by literal altitude. Royal House, upper nobles, minor nobles, merchants, tradeworkers, Underrock..." },
      { id: "underrock", label: "The Underrock (The Bilge)", placeholder: "The lowest caste. Goggles at age 6. Bioluminescent reservoirs. Engine stokers and pipe-fitters. The two-name dynamic..." },
      { id: "culture", label: "Culture & Daily Life", placeholder: "Victorian steampunk meets Asian fusion. Pagoda forms with brass clockwork integrated. Engineered waterfalls..." },
      { id: "minhui", label: "Mínhuì in Hiding", placeholder: "The sky fox god hiding among the Underrock folk for centuries, telling stories that keep the old truths alive..." },
      { id: "ariaorigin", label: "Aria's Birthplace", placeholder: "Born where no magic dwells. The tradeworker district. The orphanage. The cupcake she cannot afford..." },
    ],
  },
  {
    id: "fellowship",
